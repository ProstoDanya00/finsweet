    ...
    (() => {
            ...
            function windowLoad() {
                ...
                function digitsCountersAnimate(digitsCounter) {
                    ...
                    const step = timestamp => {
                        ...
                        digitsCounter.innerHTML = `${Math.floor(progress * (startPosition + startValue))}.000+`;
                ...
                let sections = document.querySelectorAll('[class*="about__"],[class*="feature__"]');
        ...
        function initSliders() {
            ...
            if (document.querySelector(".clients__slider")) new core(".clients__slider", {
                ...
                parallax: true,
                navigation: {
                    prevEl: ".controls-arrows__prev",
                    nextEl: ".controls-arrows__next"
                },
                on: {}
            });
